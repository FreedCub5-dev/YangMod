...
namespace YangMod.Modules.BaseStates
{
    public abstract class BaseMeleeAttack : BaseSkillState, SteppedSkillDef.IStepSetter
    {
        ...
        protected virtual void OnHitEnemyAuthority()
        {
            ...
            if (!hasHopped)
            {
                if (characterMotor != null && !characterMotor.isGrounded && hitHopVelocity > 0f)
                {
        ...
        private void RemoveHitstop()
        {
            ...
            inHitPause = false;
            if (characterMotor != null) characterMotor.velocity = storedVelocity;
        }
